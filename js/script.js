...
*/
// ・「id="tab-menu"のaタグがクリックされたときに、処理を実行してください」の意味になる。

// $("#tab-contents .tab").hide();
// ・id="tab-contents"内のいずれかのタブがクリックされたときに、そのタブ内の全コンテンツをいったん非表示にしている。
...
// 　　→タブを切り替えるときは、このCSS設定もいったん削除しなければならないため、.removeClass()にactiveクラスを指定している。
